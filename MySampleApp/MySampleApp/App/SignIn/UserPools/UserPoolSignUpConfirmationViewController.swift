...
class UserPoolSignUpConfirmationViewController : UIViewController, UITextViewDelegate {
    ...
    @IBAction func didSelectConfirmCodeBackgroundButton(sender: AnyObject) {
        self.confirm()
    }
    
    @IBAction func didSelectConfirmCodeButton(sender: AnyObject) {
        self.confirm()
    }
